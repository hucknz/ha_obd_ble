...
# Adapter-specific UUIDs (for manual configuration if auto-detection fails)
# JFIND JF327 / JFIND adapters
JFIND_SERVICE_UUID = "0000fff0-0000-1000-8000-00805f9b34fb"
JFIND_CHARACTERISTIC_UUID_READ = "0000fff1-0000-1000-8000-00805f9b34fb"
JFIND_CHARACTERISTIC_UUID_WRITE = "0000fff1-0000-1000-8000-00805f9b34fb"

# BLE local names to search for when scanning for adapters
# Supports: OBDBLE/LeLink2/ELM327 variants and JFIND OBD adapters
BLE_LOCAL_NAMES = {"OBDBLE", "OBD-BLE", "OBD BLE", "LeLink", "LeLink2", "ELM327", "JFIND"}
